...
export interface MoviePostersPageProps {
  data: MoviePostersTransformedData;
}

interface MoviePostersTransformedData {
  title: string;
  images: MovieImagesApiResponse["posters"];
  release_date: string;
...
export const getServerSideProps: GetServerSideProps<{
  ...
  const response: MoviePostersPageApiResponse | ApiError = await res.json();
  ...
  if ("id" in response && response.id) {
    ...
    const transformedData: MoviePostersTransformedData = {
      title,
...
const MoviePostersPage: React.FC<MoviePostersPageProps> = ({ data }) => {
  ...
  return (
    <>
      ...
      <div className="app-container content-with-aside panel-details">
        <DetailLayout>
          <MovieImagesBlock images={images} title={title} type="poster" />
        </DetailLayout>
      </div>
    </>
  );
