...
import styles from "./TVVideosBlock.module.scss";

interface TVVideosBlockProps {
  videos: Video[];
}
...
const TVVideosBlock: React.FC<TVVideosBlockProps> = ({ videos }) => {
